...
export const phenotypeTypes = [
  defineType({
    ...
    code: 'GN-BF9',
    tagline: 'Light iris lattice, high cheekbone relief',
  ...
  defineType({
    ...
    code: 'GN-NA7',
    tagline: 'North Sea cluster, cool-fair identifiers',
  ...
  defineType({
    ...
    code: 'GN-CE5',
    tagline: 'Mixed continental identifiers, moderate tribal signal',
  ...
  defineType({
    ...
    code: 'GN-AH4',
    tagline: 'Broader midface, mid melanin cluster',
  ...
  defineType({
    ...
    code: 'GN-MB3',
    tagline: 'Southern coastal cluster, olive melanin range',
  ...
  defineType({
    ...
    code: 'GN-IA6',
    tagline: 'Atlantic-Mediterranean overlap, dark hair cluster',
  ...
  defineType({
    ...
    code: 'GN-PS20',
    tagline: 'Steppe cluster, wide zygomatic relief',
  ...
  defineType({
    ...
    code: 'GN-LC8',
    tagline: 'Warm olive cluster, prominent nose identifier',
  ...
  defineType({
    ...
    code: 'GN-PP19',
    tagline: 'Plateau cluster, high nasal relief',
  ...
  defineType({
    ...
    code: 'GN-MC2',
    tagline: 'North African coastal cluster, mixed breadth',
  ...
  defineType({
    ...
    name: 'Nile-Saharan I',
    code: 'GN-NS1',
    tagline: 'High melanin cluster, mid-breadth identifiers',
  ...
  defineType({
    ...
    name: 'Horn Plateau X',
    code: 'GN-HP10',
    tagline: 'High melanin, narrower nasal identifier',
  ...
  defineType({
    ...
    code: 'GN-SS13',
    tagline: 'Deep melanin cluster, wide-nose identifier',
  ...
  defineType({
    ...
    code: 'GN-WG11',
    tagline: 'Deep melanin, full-lip and wide-nose identifiers',
  ...
  defineType({
    ...
    code: 'GN-AH14',
    tagline: 'High zygomatic relief, mid melanin cluster',
  ...
  defineType({
    ...
    code: 'GN-AB15',
    tagline: 'Broad midface, darker hair cluster',
  ...
  defineType({
    ...
    code: 'GN-EA16',
    tagline: 'Wide facial index, darker hair, mid melanin',
  ...
  defineType({
    ...
    code: 'GN-IP17',
    tagline: 'Broad facial cluster, full-lip identifier',
  ...
  defineType({
    ...
    code: 'GN-SA18',
    tagline: 'Warm melanin cluster, mid nasal identifier',
